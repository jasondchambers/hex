...
class TestFormatUtils(unittest.TestCase) :
    ...
    def test_columnize_1(self):
        ...
        rows = format_utils.convert_to_list(
            format_utils.columnize(list_of_strings, number_of_columns=1, column_width=4))
    ...
    def test_columnize_2(self):
        ...
        rows = format_utils.convert_to_list(
            format_utils.columnize(list_of_strings, number_of_columns=2, column_width=39))
    ...
    def test_columnize_3(self):
        ...
        rows = format_utils.convert_to_list(
            format_utils.columnize(list_of_strings, number_of_columns=5, column_width=15))
    ...
    def test_columnize_4(self):
        ...
        rows = format_utils.convert_to_list(
            format_utils.columnize(list_of_strings, number_of_columns=6, column_width=15))
    ...
    def test_columnize_5(self):
        ...
        rows = format_utils.convert_to_list(
            format_utils.columnize(list_of_strings, number_of_columns=7, column_width=10))
    ...
    def test_columnize_7(self):
        ...
        rows = format_utils.convert_to_list(
            format_utils.columnize(list_of_strings, number_of_columns=1, column_width=3))
    ...
    def test_columnize_8(self):
        ...
        rows = format_utils.convert_to_list(
            format_utils.columnize(list_of_strings, number_of_columns=1, column_width=2))
    ...
    def test_columnize_9(self):
        ...
        rows = format_utils.convert_to_list(
            format_utils.columnize(list_of_strings, number_of_columns=1, column_width=0))
    ...
    def test_columnize_10(self):
        ...
        rows = format_utils.convert_to_list(
            format_utils.columnize(list_of_strings, number_of_columns=1, column_width=-1))
